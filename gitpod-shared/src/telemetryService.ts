...
export class TelemetryService extends Disposable implements ITelemetryService {
	...
	constructor(extensionId: string, extensionVersion: string, segmentKey: string, piiPaths: string[], userId: string, gitpodHost: string, private readonly logService: ILogService) {
		super();
